                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="space-y-4">
                        <form action="/comptes/{{$compte->id}}" method="POST">
                            ...
                            <input type="number" id="taux_remuneration" name=taux_remuneration  value="{{$compte->taux_remuneration}}" step="0.01" class="w-full rounded text-black" style="color:black">
                            <br>
                            <label for="taux_imposition">Taux d'imposition :</label>
                            <input type="number" id="taux_imposition" name=taux_imposition}} value="{{$compte->taux_imposition}}" step="0.01" class="w-full rounded text-black" style="color:black">
                            <br>
